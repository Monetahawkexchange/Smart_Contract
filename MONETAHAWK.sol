...
{ using SafeMath for uint256;
    ...
    uint public _totalsupply = 100000000 * 10 ** 18; // 100 M inculding decimal precesion
    ...
    address ethFundMain = xxxxxxxxxxxxxxxxxxxxxxxx; 
    ...
    constructor() public
    {
        ...
        owner = msg.sender;
        balances[owner] = 25000000 * 10 **18;  //25 Million given to Owner
        balances[address(this)]=  75000000 * 10 **18;  //75 Million given to Smart Contract
    ...
    function start_PRIVATESALE() public onlyOwner atStage(Stages.NOTSTARTED)
      {
          ...
          stopped = false;
         _price_tokn = 5000;     // 1 Ether = 5000 MNH
          pre_startdate = now;
